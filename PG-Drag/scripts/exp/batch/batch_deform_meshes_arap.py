"""
batch_deform_meshes_arap.py

A script for batch mesh deformation experiments with ARAP.
"""
...
from utils import launch_job_on_gpu

# global variables
SRC_SCRIPT_PATH = Path(__file__).parent / "../deform_meshes_arap.py"
...
class Args:
    ...
    data_list_path: Path = Path("configs/deform_meshes_arap/apap_3d.txt")
    """Path to the file holding the list of data"""
    out_root: Path = Path("outputs/deform_meshes_arap")
